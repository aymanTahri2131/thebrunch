    ...
    <div className="min-h-screen">
      ...
      <div className="flex flex-col sm:flex-col lg:flex-row w-full items-center justify-center p-12 gap-12 h-auto sm:h-auto lg:h-[350px] bg-[#B8B2B2]/40 text-white">
       <div className="flex flex-col items-center justify-center gap-6 text-center">
          ...
          <p className="text-center max-w-[400px] text-lg" style={{ fontFamily: "Inconsolata", monospace" }}>thebrunch est une pépite pour les amateurs de pâtisserie fine. Chaque création est faite avec des ingrédients de grande qualité, et ça se sent dès la première bouchée. Les saveurs sont délicates, bien équilibrées, et les textures parfaitement maîtrisées. En plus du talent évident, il y a une vraie gentillesse et une passion qui se ressentent dans l’accueil comme dans chaque détail. Un grand merci à thebrunch pour son savoir-faire et sa générosité.</p>
        </div>
        <div className="flex flex-col items-center justify-center gap-6 text-center">
          <Heart size={40} />
          <h2 className="text-[#4a3b36] font-semibold text-lg" style={{ fontFamily: "Poppins, sans-serif" }}>Lina S</h2>
          <p className="text-center max-w-[400px] text-lg" style={{ fontFamily: "Inconsolata", monospace" }}>J’ai enfin découvert les trompe-l’œil de thebrunch … et quelle magnifique surprise!
          Les visuels sont tout simplement bluffants, les jeux de textures parfaitement maîtrisés, et la qualité des produits se ressent à chaque bouchée. Un véritable travail d’orfèvre, aussi beau que bon. Gros coup de cœur pour la pistache, la vanille et la framboise !
          </p>
          ...
          <p className="text-center max-w-[400px] text-lg" style={{ fontFamily: "Inconsolata", monospace" }}>Un travail minutieux et de qualité, les produits sont frais. Après avoir goûté pratiquement toute la carte (sucré et salé), je peux affirmer que c’est aussi beau que bon et même plus que ça. Tout est excellent un vrai travail de chef. Les tartes sont dignes d’un grand chef pâtissier. Bravo et merci !</p>
        
        </div>
          <div className="flex flex-col items-center justify-center gap-6 text-center">
          <Heart size={40} />
          <h2 className="text-[#4a3b36] font-semibold text-lg" style={{ fontFamily: "Poppins, sans-serif" }}>Manal K</h2>
          <p className="text-center max-w-[400px] text-lg" style={{ fontFamily: "Inconsolata", monospace" }}>Cela fait des années que je suis cette cheffe traiteur sur les réseaux sociaux, et c’est toujours un plaisir de voir une personne aussi passionnée et talentueuse. Son savoir-faire est indéniable, et chaque création reflète son amour pour la cuisine. Elle travaille énormément pour offrir des prestations de qualité, et ça se ressent dans chacun de ses plats. Je recommande vivement !</p>
