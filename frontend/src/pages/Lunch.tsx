        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <p className="text-sm md:text-base mb-8 text-white/90 max-w-2xl mx-auto" style={{ fontFamily: '"Inconsolata", monospace' }}>
              Découvrez une sélection raffinée, soigneusement imaginée pour vous offrir une expérience culinaire généreuse, 
              inventive et subtilement orchestrée autour des saveurs les plus délicates.
            </p>
        </div>
      </section>
