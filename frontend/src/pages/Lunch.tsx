...
const Lunch = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section className="relative h-[60vh] pt-28 flex items-center justify-center overflow-hidden">
        <div
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          ...
          <p className="text-sm md:text-base mb-8 text-white max-w-2xl mx-auto">
                ...
                <div className="grid sm:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6 max-w-6xl mx-auto mb-8">
                  {category.products?.map((product, index) => (
                    <Card
                      ...
                      className="group overflow-hidden hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 bg-white rounded-2xl"
                    >
                      ...
                      <div className="p-6">
                        ...
                        <CardContent className="p-0 text-gray-600 text-sm leading-relaxed line-clamp-3">
                          {product.description}
                        </CardContent>
                      </div>
                    </Card>
